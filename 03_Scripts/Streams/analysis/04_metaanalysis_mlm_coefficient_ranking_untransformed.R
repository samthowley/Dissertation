...
# Exploratory sibling of 04_metaanalysis_mlm_coefficient_ranking.R -- same
# predictors/weighting/random effects/ranking logic, but fit on the raw
...
out_path <- "04_Output/metaanalysis_mlm_coefficient_ranking_untransformed.csv"
...
tables_out_path <- "05_Figures/Table_metaanalysis_mlm_coefficient_ranking_untransformed.docx"
